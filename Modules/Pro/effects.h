...
struct st_effect {
	...
	union {
		void (*CH_E)(channel *ch, event *e);
		void (*A_E)(automaton *a, event *e);
		void (*CH_PITCH_E)(channel *ch, pitch pitch, struct event *e);
		void (*CH_A_E)(channel *ch, automaton *a, event *e);
	} f;
};
